  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Solicita mantenimiento u otros servicios"
        icon={LifeBuoy}
        actions={
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="d">Describe el problema</Label>
        ...
        <Card>
          <CardContent className="p-0">
            <EmptyState
              ...
              description="Solicita mantenimiento, reparaciones u otros servicios al administrador."
