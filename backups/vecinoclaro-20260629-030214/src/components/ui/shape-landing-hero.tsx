...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-[88vh] w-full flex items-center justify-center overflow-hidden bg-emerald-950 pt-28 pb-16">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <ElegantShape
                    ...
                    height={140}
                    rotate={12}
                    gradient="from-emerald-400/[0.18]"
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-6 md:mb-8 tracking-tight leading-[1.05]">
                            ...
                            <span
                                className={cn(
                                    "bg-clip-text text-transparent bg-gradient-to-r from-emerald-300 via-white/90 to-amber-300 "
                                )}
                            >
                                {title2}
                            </span>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-emerald-950 via-transparent to-emerald-950/80 pointer-events-none" />
        </div>
    );
}
